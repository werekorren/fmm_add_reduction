...
#else /* individual alpha parameter domains for A, B and C */
...
//#define DEFAULT_FILE ALG_FOLDER_OTHER "Strassen-222-7-18.txt";
//#define DEFAULT_FILE ALG_FOLDER_OTHER "Strassen-222-7-24.txt";
//#define DEFAULT_FILE ALG_FOLDER_OTHER "Smirnov-333-23-139.txt";
#define DEFAULT_FILE ALG_FOLDER_OTHER "Laderman-333-23-98.txt";
//#define DEFAULT_FILE ALG_FOLDER_OTHER "Adaptive-455_73-mod2.m";
//#define DEFAULT_FILE ALG_FOLDER_OTHER "Adaptive-555_94-mod2.m";

#define ALG_FOLDER_GREY "algorithms/grey/"
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-234-20-144.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-322-11-50.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-323-15-103.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-422-14-84.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-423-20-144.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-522-18-99.txt";

//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-333-23-142.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-333-23-143.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-333-23-144.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-333-23-152.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-333-23-221.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-433-29-234.txt";
//#define DEFAULT_FILE ALG_FOLDER_GREY "Grey-343-29-234.txt";
...
//#define DEFAULT_FILE ALG_FOLDER_MOOSBAUER "Moosbauer-356-71-mod2.exp"; // 819 -> 322 = 59 + 114 + 149 with alpha = (0.1,0.11,0.055)
//#define DEFAULT_FILE ALG_FOLDER_MOOSBAUER "Moosbauer-555-95-mod2.exp";
//#define DEFAULT_FILE ALG_FOLDER_MOOSBAUER "Moosbauer-556-116-mod2.exp";
//#define DEFAULT_FILE ALG_FOLDER_MOOSBAUER "Moosbauer-566-144-mod2.exp"; // 99 + 314 + 353 = 766 (0.05, 0.095, 0.035)
//#define DEFAULT_FILE ALG_FOLDER_MOOSBAUER "Moosbauer-666-164-mod2.exp";
...
int main(int argc, char **argv) {
  ...
  int t_capacity = 10;
  printf("Using file %s\n\n", fn);
  if (read_from_file(&alg, fn, t_capacity, VERBOSE_FILE_READ)) {
